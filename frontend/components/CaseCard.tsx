  ...
  return (
    ...
    >
      <div className="relative z-10">
        {/* Icon container */}
        <div className="aspect-square bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl mb-4 flex items-center justify-center overflow-hidden relative">
          ...
          {caseData.discount > 0 && (
            <motion.div
              ...
              className="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg"
            >
              -{caseData.discount}%
            </motion.div>
          )}
