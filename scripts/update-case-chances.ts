...
async function main() {
  ...
  const legendaryPoolChance = 5.0; // 5% на всю категорию
  const masterPoolChance = 20.0; // 20% на всю категорию
  const veteranPoolChance = 35.0; // 35% на всю категорию
  const stalkerPoolChance = 40.0; // 40% на всю категорию
